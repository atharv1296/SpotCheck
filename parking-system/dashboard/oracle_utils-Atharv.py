...
def test_oracle_connection():
    ...
    try:
        ...
        print("   2. Verify ORACLE_* environment variables or settings.py")
        print("   3. Ensure python-oracledb is installed: pip install oracledb")
        print("   4. If using thick mode, verify Instant Client and PATH")
        print("   5. Check Oracle listener status")
        return False
